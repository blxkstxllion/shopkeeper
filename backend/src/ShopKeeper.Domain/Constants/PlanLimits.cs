...
public record PlanLimitInfo(int MaxBranches, int MaxProducts, int MaxStaff, bool HasReports, bool HasAi, bool HasCustomRoles);

public static class PlanLimits
{
    public static PlanLimitInfo For(PlanTier tier) => tier switch
    {
        PlanTier.Free => new PlanLimitInfo(2, 25, 2, false, false, false),
        PlanTier.Business => new PlanLimitInfo(5, 250, 10, true, false, false),
        PlanTier.BusinessAi => new PlanLimitInfo(5, 250, 10, true, true, false),
        PlanTier.Enterprise => new PlanLimitInfo(int.MaxValue, 2000, int.MaxValue, true, false, true),
        PlanTier.EnterpriseAi => new PlanLimitInfo(int.MaxValue, 2000, int.MaxValue, true, true, true),
